...
import Accordions from '../../components/mobilemenu/MenuAccordians';
...
const MobileMenu = ({ currentUser }) => {
    ...
    return (
        <>
            {modal.isOpen && (
                <ModificationsModal onToggle={onToggle} modalState={modal} onAddModifiedOrder={onAddModifiedOrder} />
            )}
